...
const CONST = 0, UNARY = 1, BINARY = 2, INFIX = 3, LEFTBRACKET = 4, RIGHTBRACKET = 5, SPACE = 6, UNDEROVER = 7, DEFINITION = 8, LEFTRIGHT = 9, TEXT = 10; // token types
const AMsqrt = {
    input: 'sqrt',
    tag: 'msqrt',
    output: 'sqrt',
    ...
    tex: null,
    ttype: BINARY,
}, AMfrac = { input: 'frac', tag: 'mfrac', output: '/', tex: null, ttype: BINARY }, AMdiv = { input: '/', tag: 'mfrac', output: '/', tex: null, ttype: INFIX }, AMover = {
    input: 'stackrel',
    tag: 'mover',
    output: 'stackrel',
    tex: null,
    ttype: BINARY,
}, AMsub = { input: '_', tag: 'msub', output: '_', tex: null, ttype: INFIX }, AMsup = { input: '^', tag: 'msup', output: '^', tex: null, ttype: INFIX }, AMtext = {
    input: 'text',
    tag: 'mtext',
    output: 'text',
    tex: null,
...
function refreshSymbols() {
    ...
    AMsymbols.sort((s1, s2) => {
        var _a, _b;
        if (((_a = s1.input) !== null && _a !== void 0 ? _a : '') > ((_b = s2.input) !== null && _b !== void 0 ? _b : ''))
            return 1;
        else
            return -1;
    });
...
function AMTparseExpr(str, rightbracket) {
    let symbol, node, result, i, newFrag = '';
